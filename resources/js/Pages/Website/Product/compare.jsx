    ...
    return (
        <FrontLayout>
            <section className="container">
                <div className="py-6 px-12 sm:px-10">
                        ...
                        <table className="min-w-[600px] w-full text-left">
                            <tbody>
                                ...
                                <tr className="border-t">
                                    <td className="p-2 font-medium text-black">Product Information</td>
                                    {products.map((p) => (
                                ...
                                <tr className="border-t">
                                    ...
                                    {products.map((p) => (
                                        <td key={p.id} className="p-4 text-center bg-white">
                                            ...
                                            <div className="text-black">Min. order : 1 meter</div>
                                        </td>
                                    ))}
                                </tr>
                                ...
                                <tr className="border-t">
                                    ...
                                    {products.map((p, i) => (
                                        <td key={i} className="p-4 text-center text-black bg-white">&#8377;{19 + i * 5}.00 for 1 meter</td>
                                    ))}
                                </tr>
